...
1. **Doesn't join meetings.**
   ...
   - body: `Quietly AI never joins your meetings, so there are no bots and no extra people on the guest list.`
2. **Invisible to screen share.**
   ...
   - body: `Quietly AI never shows up in shared screens, recordings, or external meeting tools.`
3. **Follows your eyes.**
   ...
   - body: `Quietly AI window is fully moveable so you can position it exactly where you're looking.`
...
Doesn't join meetings. Quietly AI never joins your meetings, so there are no bots and no extra people on the guest list.

Invisible to screen share. Quietly AI never shows up in shared screens, recordings, or external meeting tools.

Follows your eyes. Quietly AI window is fully moveable so you can position it exactly where you're looking.
