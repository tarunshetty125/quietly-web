...
const rootPages: readonly ContentPage[] = [
  {
    ...
    category: "Legal",
    eyebrow: "Security",
    title: "Security that keeps TeamSync private by design.",
    summary:
      "TeamSync is built for conversations where context matters and exposure cannot happen. The product keeps local workflows local, limits cloud processing, and makes sensitive meeting data easy to control.",
    primaryCta: "Review privacy controls",
    sections: [
      {
        heading: "Local-first capture",
        body:
          "TeamSync can process meeting audio, screen context, and notes on-device whenever your setup allows it. That reduces the amount of raw conversation data leaving your machine and keeps assistants useful in restricted environments.",
      ...
      },
      {
        ...
        body:
          "When teams choose managed AI, TeamSync sends only the context needed for a specific answer. Admins can choose model providers, set workspace rules, and keep the assistant aligned with company policy.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync is designed for private work. We avoid invasive meeting bots, keep controls visible to the user, and make it clear when AI context is being used.",
    primaryCta: "Explore local AI",
    sections: [
      {
        heading: "What TeamSync uses",
        body:
          "TeamSync uses meeting audio, visible screen context, uploaded files, and user prompts only to produce notes, answers, summaries, and follow-up suggestions for the person using the app.",
      },
      {
        heading: "What TeamSync avoids",
        body:
          "TeamSync does not need to join your meeting as a participant. It is built to assist from your device, so your call does not get interrupted by a visible recording bot.",
  ...
  },
  {
    ...
    summary:
      "TeamSync plans are meant to be easy to evaluate. If the product is not a fit, the refund page explains how to contact us and what information helps us resolve the request quickly.",
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Include the purchase email, the plan name, and a short note about what did not work. That helps the TeamSync team respond with the right next step instead of a generic checklist.",
      },
    ],
  ...
  },
  {
    ...
    title: "Clear rules for using TeamSync responsibly.",
    summary:
      "TeamSync is a real-time assistant for meetings, interviews, classes, and sales calls. The terms page explains acceptable use, account responsibilities, and workspace ownership.",
    primaryCta: "Read privacy policy",
    sections: [
      {
        heading: "Responsible assistance",
        body:
          "Use TeamSync to understand conversations, remember details, and prepare stronger responses. Users remain responsible for how they disclose, record, and apply AI-generated suggestions.",
      },
      {
  ...
  },
  {
    ...
    summary:
      "TeamSync helps candidates keep structure during live interviews by breaking down prompts, surfacing trade-offs, and turning pressure into a clear answer plan.",
    primaryCta: "See TeamSync Pro in action",
    sections: [
      {
        heading: "Answer with structure",
        body:
          "Instead of dumping generic code, TeamSync frames the problem, names constraints, suggests a plan, and reminds you to explain complexity and edge cases out loud.",
        bullets: ["Problem breakdown", "System design scaffolding", "Behavioral answer prompts"],
      },
      {
        heading: "Use your own context",
        body:
          "TeamSync Pro can ground answers in your resume, target job description, and notes so your responses sound like your actual experience instead of a public template.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync turns live prompts into implementation steps, test cases, and explanation cues so you can keep talking while you solve.",
    primaryCta: "Explore interview mode",
    sections: [
      {
        heading: "From prompt to plan",
        body:
          "When a graph, dynamic programming, or data structure question appears, TeamSync helps identify the likely pattern and the decision points you should explain.",
      },
      {
  ...
  },
  {
    ...
    summary:
      "TeamSync is designed around local-first workflows for people who want answers, notes, and context without sending everything to a meeting bot.",
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Teams can still use managed models when they want higher intelligence. TeamSync keeps that choice explicit and context-aware.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync helps you practice the habits that matter in coding exams: clarifying constraints, choosing an approach, testing edge cases, and explaining complexity.",
    primaryCta: "Read the coding guide",
    sections: [
      {
        heading: "Practice with feedback",
        body:
          "Use TeamSync to create follow-up questions after a practice problem, then compare your explanation against a concise answer structure.",
      },
      {
        heading: "Stay calm under time",
        body:
          "When a timed exercise gets tense, TeamSync keeps the next step visible: define inputs, choose the data structure, write tests, then optimize.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "The best interview assistance is not just an answer. TeamSync helps you reveal your process, explain trade-offs, and recover quickly when a question changes.",
    primaryCta: "Open interview guide",
    sections: [
      {
        heading: "More than syntax",
        body:
          "TeamSync can remind you why an approach works, where it fails, and what complexity you should mention before the interviewer asks.",
      },
      {
        heading: "Better follow-ups",
        body:
          "After the first answer, TeamSync can suggest thoughtful follow-up questions about scale, constraints, and production behavior.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync gives developers a discreet, context-aware helper for live debugging, architecture discussions, and interview-style coding.",
    primaryCta: "Explore local AI",
    sections: [
      {
      ...
      },
      {
        ...
        body:
          "TeamSync focuses on concise next steps: what to inspect, what to test, and how to explain the likely issue to another engineer.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "A useful interview tool should be fast, private, explainable, and grounded in your background. TeamSync is shaped around those four requirements.",
    primaryCta: "Compare TeamSync Pro",
    sections: [
      {
      ...
      },
      {
        ...
        body:
          "The best tool helps you sound like yourself. TeamSync Pro uses your resume and role context so suggestions match the story you are actually trying to tell.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync listens locally, captures decisions, and gives you answers while the conversation is still happening.",
    primaryCta: "See meeting workflow",
    sections: [
      {
        heading: "Live help",
        body:
          "Ask TeamSync for a recap, a clearer answer, a follow-up question, or a decision summary without breaking the meeting flow.",
      },
      {
        heading: "Clean notes",
        body:
          "After the call, TeamSync turns the conversation into structured notes with owners, dates, open risks, and next steps.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync captures useful meeting notes from your side of the call, then organizes the output into summary, action items, and decisions.",
    primaryCta: "Try meeting notes",
    sections: [
      {
        heading: "Notes people can scan",
        body:
          "TeamSync prioritizes clear sections over raw transcript dumps: summary, decisions, action items, blockers, owners, and follow-ups.",
      },
      {
        heading: "Invisible to the room",
        body:
          "Because TeamSync does not need to join as a participant, teammates do not have to manage another bot tile on every calendar invite.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync tracks buyer language, pricing concerns, urgency, and decision-maker signals so reps can respond with more precision.",
    primaryCta: "Explore sales mode",
    sections: [
      {
        heading: "Objection support",
        body:
          "When a prospect raises pricing, timing, security, or migration concerns, TeamSync surfaces a concise talk track and a follow-up question.",
      },
      {
        heading: "Cleaner handoff",
        body:
          "After the call, TeamSync summarizes pain points, deal risks, next steps, and the exact language the customer used.",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "TeamSync turns classes, workshops, and training calls into clean notes with definitions, examples, and review prompts.",
    primaryCta: "Explore lecture mode",
    sections: [
      {
        heading: "Capture the structure",
        body:
          "TeamSync separates concepts, examples, formulas, and instructor emphasis so the final notes are useful when you study later.",
      },
      {
        heading: "Ask while learning",
        body:
          "During the lecture, ask TeamSync to simplify a concept, produce an analogy, or recap the last five minutes.",
      },
    ],
  ...
  },
  {
    ...
    category: "Meeting AI",
    eyebrow: "Alternative",
    title: "A TeamSync alternative for teams that do not want meeting bots.",
    summary:
      "If your team wants private notes and real-time help without adding another participant to every call, TeamSync is built for that workflow.",
    primaryCta: "Compare meeting AI",
    sections: [
      {
        heading: "No bot tile",
        body:
          "TeamSync assists from your device, avoiding the friction of external bot approvals, visible attendees, and awkward recording reminders.",
      },
      {
        heading: "Help during the call",
        body:
          "Many note tools focus on after-the-fact summaries. TeamSync also helps you answer questions, clarify points, and remember context live.",
      },
    ],
  ...
  },
  {
    ...
    category: "Meeting AI",
    eyebrow: "Alternative",
    title: "A real-time TeamSync alternative for transcription-first tools.",
    summary:
      "TeamSync combines transcription, notes, and live AI assistance so the meeting output is useful before and after the call ends.",
    primaryCta: "See TeamSync notes",
    sections: [
      {
        heading: "Beyond transcripts",
        body:
          "Raw transcript search is helpful, but teams need decisions, action items, risks, and follow-ups. TeamSync turns the conversation into those artifacts.",
      },
      {
        heading: "Private live context",
        body:
          "TeamSync can help you formulate answers while the call is happening, using visible context and conversation history from your side.",
      },
    ],
...
const blogPages: readonly ContentPage[] = [
  {
    ...
    category: "Blog",
    eyebrow: "Guide",
    title: "The TeamSync guide to using an AI interview assistant.",
    summary:
    ...
    sections: [
      {
        ...
        body:
          "TeamSync is most useful when it keeps your answer organized: clarify the problem, state assumptions, choose an approach, test edge cases, and explain trade-offs.",
      },
      {
  ...
  },
  {
    ...
    summary:
      "Local AI gives privacy and resilience. Cloud AI gives stronger models and managed infrastructure. TeamSync supports workflows that can use both intentionally.",
    primaryCta: "Explore local AI",
    sections: [
      {
      ...
      },
      {
        ...
        body:
          "For deeper reasoning, company research, and larger context windows, managed models can be valuable. TeamSync makes that trade-off explicit.",
      },
    ],
    ...
    sections: [
      {
        ...
        body:
          "TeamSync can remind you to say why a data structure fits, what the runtime is, and how you would test failure cases.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Good copilots avoid long essays. TeamSync produces compact suggestions that can be read quickly while the conversation continues.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Where TeamSync fits",
        body:
          "TeamSync focuses on live assistance across interviews, meetings, sales calls, and lectures, with Pro context for resume and company-specific answers.",
      },
    ],
  ...
  },
  {
    ...
    category: "Blog",
    eyebrow: "Preparation",
    title: "Preparing for technical screenings with TeamSync.",
    summary:
      "Use TeamSync before the interview to rehearse explanations, organize project stories, and practice the questions that usually cause hesitation.",
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "TeamSync can generate interviewer-style follow-ups so you practice adapting, not just memorizing one polished response.",
      },
    ],
