...
function ModeVisual() {
  return (
    <div className="h-6 w-14 overflow-hidden pr-1 text-right font-mono text-[8.5px] font-bold text-indigo-500">
      <div className="quietly-pro-mode-list space-y-[4px]">
        <div>Interview</div>
        <div>Sales</div>
        <div>Lecture</div>
      </div>
...
function ResumeVisual() {
  return (
    <div className="relative flex h-6 w-12 shrink-0 flex-col justify-around overflow-hidden rounded border border-slate-200/50 bg-slate-100/60 p-1">
      ...
      <span className="quietly-pro-resume-scan absolute right-0 left-0 h-px bg-indigo-500/50 shadow-[0_0_3px_rgba(99,102,241,0.5)]" />
    </div>
  );
}
...
function ContextVisual() {
  return (
    <div className="relative flex h-6 w-12 shrink-0 items-center justify-center overflow-hidden">
      <span className="quietly-pro-context-node-a absolute size-1.5 rounded-sm bg-indigo-400/80" />
      <span className="quietly-pro-context-node-b absolute size-1.5 rounded-sm bg-indigo-400/80" />
...
export function QuietlyAIProSection() {
  return (
    <section
      id="quietly-pro"
    ...
    >
      <div
        aria-hidden="true"
        className="quietly-pro-noise pointer-events-none absolute inset-0 opacity-[0.015]"
      />
      <div
        aria-hidden="true"
