    ...
    >
        ...
        <div className="flex h-[500px] items-start justify-center px-3 pt-20 text-center lg:pt-32">
          <div className="flex flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-4">
              <Link
                href="/v2"
                className="v2-glass-pill group inline-flex items-center gap-2 rounded-lg px-3 py-2 text-[13px] transition-all duration-300 hover:bg-white/[0.04]"
              >
                <span
                ...
                <svg className="size-3 text-white/30 transition-transform duration-200 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
              </Link>
              <h1
            ...
            <div className="cluely-hero-cta flex flex-col items-center gap-3">
              <div className="flex flex-wrap justify-center gap-3">
                ...
                <PlatformCta
                  platform="windows"
                  href="https://github.com/tarunshetty125/TeamSync/releases/download/v2.7.3/Quietly-Setup-2.7.3.exe"
                  onClick={() => setTimeout(() => setShowWinDownloadOverlay(true), 1000)}
                />
              </div>
              <a
                href="https://github.com/tarunshetty125/TeamSync/releases/download/v2.7.3/Quietly-2.7.3.dmg"
      ...
      {showIntelOverlay && (
        <DownloadOverlay
          ...
          downloadUrl="https://github.com/tarunshetty125/TeamSync/releases/download/v2.7.3/Quietly-2.7.3.dmg"
        />
      )}
