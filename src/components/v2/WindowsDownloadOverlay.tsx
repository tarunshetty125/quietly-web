...
const DOWNLOAD_URL =
  "https://github.com/tarunshetty125/TeamSync/releases/download/v2.7.3/Quietly-Setup-2.7.3.exe";
...
const winSteps: Step[] = [
  {
    ...
    desc: "Open Quietly-Setup-2.7.3.exe from your Downloads.",
